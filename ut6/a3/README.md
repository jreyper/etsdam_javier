...
Las pruebas iniciales solo se centraban en los errores. Específicamente, la suma de la nota dentro del bucle y la operación matemática del ``return`` final nunca llegaban a procesarse.
